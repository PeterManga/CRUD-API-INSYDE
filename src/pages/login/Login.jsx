        ...
        <div className='container-fluid mt-5 '>
            <div className='w-75 p-3 container shadow-lg p-3 mb-5 bg-white rounded login'>
                <div className="d-flex flex-column  align-items-center justify-content-center p-3 shadow position-relative overflow-hidden " style={{ backgroundColor: '#fff' }}>
                    <div className="position-absolute" style={{ content: '', width: '300px', height: '200px', backgroundColor: 'rgb(209, 193, 255)', transform: 'rotate(45deg)', left: '-180px', bottom: '30px', zIndex: '1', borderRadius: '30px', boxShadow: '5px 5px 10px rgba(0, 0, 0, 0.082)' }}></div>
                    <h1 className="font-weight-bold display-1" style={{ color: '#2e2e2e', zIndex: '2' }}>Login</h1>
                    <div className='container '>
                        <Form className="position-relative d-flex flex-column  align-items-center justify-content-center gap-5" style={{ zIndex: '2', height: '400px' }}>
                            <Form.Group className="w-100 mb-2 position-relative" controlId="formBasicEmail">
                            ...
                            <Form.Group className="w-100 mb-2 position-relative" controlId="formPassword">
                            ...
                            <Button variant="primary" type="submit" className="w-100 position-relative" style={{ zIndex: '2', height: '30px', color: 'white', fontSize: '.8em', fontWeight: '500', letterSpacing: '1px', margin: '10px', cursor: 'pointer', backgroundColor: 'rgb(162, 104, 255)' }}>
                                Submit
                            </Button>
                        </Form>
                    </div>
